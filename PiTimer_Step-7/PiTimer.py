...
#/* ------------------------------------------------------------------------ */
#/* Save and load application state after schedule updates, so the           */
#/* applicaion and resume where it left off after an application restart or  */
#/* system restart, or system crash/hang.                                    */
#/*                                                                          */
