...
#/****************************************************************/
   def DisplayHeader(self):
      ...
      print("{:=^53}".format(""))
      print("|{:^51}|".format("CURRENT SCHEDULE " + ThisSystemTime.SystemTimeString()))
      print("{:=^53}".format(""))
      print("| {:^5}|{:^19}|{:^5}|{:^17} |".format("Relay", "Next Schedule", "State", "Repeat After"))
      print("|{:-^6}|{:-^19}|{:-^5}|{:-^18}|".format("", "", "", ""))
...
#/**********************************************************************/
   def DisplayItem(self, SelectLeftChar, SelectRightChar):
      print("|{}{:>5}|{:^19}|{:^5}|{:>17}{}|".format(SelectLeftChar, self.RelayNumber, self.ScheduleDate.strftime("%Y-%m-%d %H:%M:%S"), self.RelayState, str(self.Repeat), SelectRightChar))
