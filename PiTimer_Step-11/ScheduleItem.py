...
#/**********************************************************************/
   def DisplayItem(self, UserInterface, LineNumber, SelectLeftChar):
      ...
      Days = Period
      UserInterface.PrintLine(LineNumber, "{}{:^19}".format(SelectLeftChar, self.ScheduleDate.strftime("%Y-%m-%d %H:%M:%S")))
      UserInterface.PrintLine(LineNumber + 1, "{}{:>2}={:<2}  {:>3} {:0>2}:{:0>2}:{:0>2}".format(SelectLeftChar, self.RelayNumber, self.RelayState, str(Days), str(Hours), str(Minutes), str(Seconds)))
